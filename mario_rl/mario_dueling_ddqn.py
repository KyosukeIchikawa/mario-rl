...
class Mario:
    """Agent that learns to play Super Mario Bros using Dueling Double Deep Q-Networks (Dueling DDQN)."""
    ...
    def __init__(self, state_shape: tuple, action_dim: int):
        ...
        outputs1 = keras.layers.Dense(units=512, activation='relu', kernel_initializer="he_normal")(outputs)
        self._value = keras.layers.Dense(units=1, kernel_initializer="he_normal")(outputs1)  # [batch_size, 1]
